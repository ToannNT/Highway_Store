            ...
            <div class="wrapper_left">
                <ul>
                    <li data-li="dasboard" class="active">
                        ...
                        <p class="wrapper_left_b">HỒ SƠ</p>
                    </li>
                    <li data-li="order">
                        <i class="fa-solid fa-cart-shopping"></i>
                        <p class="wrapper_left_b"> ORDERS</p>
                    </li>
                    <li data-li="dowload">
                        <i class="fa-solid fa-download"></i>
                        <p class="wrapper_left_b">DOWNLOAD</p>
                    </li>
                    <li data-li="payment">
                        <i class="fa-solid fa-money-check-dollar"></i>
                        <p class="wrapper_left_b">PAYMENT METHOD</p>
                    </li>

                    <li data-li="address">
                        <i class="fa-solid fa-location-dot"></i>
                        <p class="wrapper_left_b"> ADDRESS</p>
                    </li>
                    <li data-li="account">
                        <i class="fa-regular fa-user"></i>
                        <p class="wrapper_left_b">ACCOUNT DETAILS</p>
                    </li>
                    <li data-li="logout">
                        <i class="fa-solid fa-arrow-right-from-bracket"></i>
                        <p class="wrapper_left_b">LOGOUT</p>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="content-product-right">
            <div class="wrapper_right">
                ...
                <div class="item dasboard">
                    <p>Xem và cập nhật</p>
                    <h4 style="color: red; font-size: bold;"><?= $thongbaone ?></h4>
                    <hr>
                    <form action="index.php?pg=update_user" method="post">
                        ...
                        <div class="information_submit">
                            ...
                            <input type="text" name="dienthoai" placeholder="Nhập số điện thoại" value="<?= $dienthoai ?>">
                        </div>
                        <!-- 7,8 -->
                        <div class="information_submit">
